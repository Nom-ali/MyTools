...
//                codelessIAPButton.onTransactionsRestored.AddListener(OnRestoreComplete);
//            }
...
//    void OnRestoreComplete(bool status, string name)
//    {
//        Debug.Log($"Restore status: {status}, Name: {name}");
//    }
