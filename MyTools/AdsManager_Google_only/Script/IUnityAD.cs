...
//            {
//                unityGameId = UnityID_Adroid.IsThisValid(IdFormat.UnityAdsGameId);
...
//            {
//                unityGameId = UnityID_iOS.IsThisValid(IdFormat.UnityAdsGameId);
...
//        {
//            if (string.IsNullOrEmpty(unityGameId))
//            {
//                Debug.LogError("Unity: Unity Ad ID is no valid");
//                yield break;
//            }

//            Debug.Log($"SDK: Unity: Initializing, ID {unityGameId}");
